  ...
  run: async (client, message, args, del, member) => {
   message.delete();
      message.channel.send({embeds: [new Discord.MessageEmbed()
            ...
            .addField('				**❯ Tổng guild:**', `${client.guilds.cache.size} guilds`, true)
            .addField(`				**❯ Tổng người:**`, `${client.users.cache.size} users`, true)
            .addField('				**❯ Tổng lệnh:**', `${client.commands.size} cmds`,true)
