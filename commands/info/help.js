...
// `>>> One of the best <:bughunter:866155261017063424> **all-in-one** Discord Bot! Hành động, Info, Utility, **Ticket**, and also a new awesome <:UPLogo:880786952205529169> __**Uptimer+**__ System!
// <:up1:866155257583501342> Many **Nsfw** and <:fun:866155255321853982> **Fun** Commands (50+)
// <:crowne:866155257225674752> **Admin** and **Auto-Hành động** and way much more!
...
//       .addField("ㅤ⠀⠀⠀ \n <:ticket1:881128707065016320> **Ticket** | ✅ **ENABLED**",
//         "`tadd`, `tclose`,`tdelete`, `tnew`,`topen`, `tremove`\n\n<a:TadaBig:870535786376859650> **Giveaways** | ✅ **ENABLED** \n`start [channel] [time] [winner] [prize]`, `end [giveaway id]` , `recoll [giveaway id]` \n\n<:UPLogo:880786952205529169> **Uptimer ** | ✅ **ENABLED** \n `add` `howtouse` `ping` `projects` `remove` `stats` `total` `uptime`")
//       .setThumbnail(client.user.displayAvatarURL())
//       .setColor(colors.uptime);
...
//         .setLabel('Admin , Auto/Hành động')
//         .setEmoji('880786952205529169')
//         .setValue('option1')
//         .setDescription('Admin , Auto/Hành động')
